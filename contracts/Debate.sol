...
contract Debate {
     ...
     *   - parentId can be 0 if attaching directly to root argument (top-level),
     *     otherwise it must be a valid argument ID.
     *   - isPro indicates if it's "pro" or "con" relative to its parent.
     *   - weight is how many tokens the user invests in this argument.
     *   - content is the textual data (markdown, etc.).
     */
